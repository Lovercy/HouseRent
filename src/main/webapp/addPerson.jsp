...
<html>
    ...
    <body style="font-family:微软雅黑">
		<div class="row-fluid">
        	<div class="span12">
             	<h3 class="heading">用户基本信息完善</h3>
            	<div class="row-fluid sepH_c">
					<div class="span12">
					<form action="<%=basePath %>personController/addPerson.do" method="post">
                    	<input type="hidden" name="userid" value=""/>
                    	<table class="table table-bordered">
                        	<tr>
                            	<td width="10%">姓名</td>
                                <td width="40%"><input type="text" name="personname"/></td>
                                <td width="10%">性别</td>
                                <td width="40%">
            ...
            <script src="code_js/addPerson.js"></script> 
